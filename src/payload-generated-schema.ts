...
export const pages_hero_links = pgTable(
  'pages_hero_links',
  {
    ...
    link_enabled: boolean('link_enabled').default(true),
...
export const post_likes_relations = pgTable(
  'post_likes_relations',
  {
    id: serial('id').primaryKey(),
    ...
    'user-uuid': varchar('user_uuid').notNull(),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
  ...
  (columns) => ({
    post_likes_relations_post_idx: index('post_likes_relations_post_idx').on(columns.post),
    post_likes_relations_updated_at_idx: index('post_likes_relations_updated_at_idx').on(
      columns.updatedAt,
    ),
    post_likes_relations_created_at_idx: index('post_likes_relations_created_at_idx').on(
      columns.createdAt,
    ),
  }),
)
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    pagesID: integer('pages_id'),
    postsID: integer('posts_id'),
    'post-likes-relationsID': integer('post_likes_relations_id'),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_post_likes_relations_id_idx: index(
      'payload_locked_documents_rels_post_likes_relations_id_idx',
    ).on(columns['post-likes-relationsID']),
    ...
    'post-likes-relationsIdFk': foreignKey({
      columns: [columns['post-likes-relationsID']],
      foreignColumns: [post_likes_relations.id],
      name: 'payload_locked_documents_rels_post_likes_relations_fk',
    }).onDelete('cascade'),
...
export const relations_post_likes_relations = relations(post_likes_relations, ({ one }) => ({
  post: one(posts, {
    fields: [post_likes_relations.post],
    references: [posts.id],
    relationName: 'post',
  }),
}))
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    'post-likes-relationsID': one(post_likes_relations, {
      fields: [payload_locked_documents_rels['post-likes-relationsID']],
      references: [post_likes_relations.id],
      relationName: 'post-likes-relations',
    }),
    mediaID: one(media, {
...
type DatabaseSchema = {
  ...
  post_likes_relations: typeof post_likes_relations
  media: typeof media
  ...
  relations_post_likes_relations: typeof relations_post_likes_relations
